...
/////////////////////////////////////////////
    ...
    protected function SetDefaultFonts()
    {
        ...
        return $this->SetFontGD('generic', 5)                   //  <-----  Alteração aqui   antes = 2
            && $this->SetFontGD('title', 5)                     //  <-----  Alteração aqui   antes = 5
            && $this->SetFontGD('legend', 5)                    //  <-----  Alteração aqui   antes = 2
            && $this->SetFontGD('x_label', 5)                   //  <-----  Alteração aqui   antes = 1
            && $this->SetFontGD('y_label', 3)                   //  <-----  Alteração aqui   antes = 1
            && $this->SetFontGD('x_title', 5)                   //  <-----  Alteração aqui   antes = 3
            && $this->SetFontGD('y_title', 5);                  //  <-----  Alteração aqui   antes = 3
    }
 ...
 *
 */
class PHPlot_truecolor extends CI_PHPlot
{
    /**
