					...
					<ul	class="nav navbar-nav pull-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Orçamento <span class="caret"></span></a>
								...
								<li><a href="<?=base_url('postImgOrcam')?>">Postar img Orçam.</a></li>	
							</ul>
						</li>	
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Rebob<span class="caret"></span></a>
								<ul class="dropdown-menu " >
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Clientes<span class="caret"></span></a>
								<ul class="dropdown-menu " >		
								<li><a href="<?=base_url('showCadClient')?>">Cadastrar Cliente</a></li>
								<li><a href="<?=base_url('showAlterClient')?>">Alterar Cliente</a></li>
								<li><a href="<?=base_url('showDelClient')?>">Excluir Cliente</a></li>
								<li><a href="<?=base_url('showListClient')?>">Listar Clientes</a></li>
								<li class="divider"></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Solicitantes<span class="caret"></span></a>
								<ul class="dropdown-menu " >
								<li><a href="<?=base_url('showCadSolic')?>">Cadastrar Solicitante</a></li>
								<li><a href="<?=base_url('showAlterSolic')?>">Alterar Solicitante</a></li>
								<li><a href="<?=base_url('showDelSolic')?>">Excluir Solicitante</a></li>
								<li><a href="<?=base_url('showListSolic')?>">Listar Solicitante</a></li>
							</ul>
						</li>	
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Admins<span class="caret"></span></a>
								<ul class="dropdown-menu " >
								<li><a href="<?=base_url('showCadUser')?>">Cadastrar Usuario</a></li>
								<li><a href="<?=base_url('alterar-senha')?>">Alterar Senha</a></li>
								<li><a href="<?=base_url('showListUser')?>">Listar Usuário</a></li>								
							</ul>
						</li>
