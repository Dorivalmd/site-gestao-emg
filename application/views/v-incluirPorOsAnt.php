						...
						<div class="row">
							...
							<fieldset class="col-md-2">
								<div class="form-group"> 
									...
									<input type="text" class="form-control input-sm" id="os-anterior" name="os_anterior" value="<?= $datOs->os_atual?>" required/> 
								</div>
							</fieldset>
							<fieldset class="col-md-1">
								<div class="form-group"> 
									<label for="historico">Histórico</label>
									<input type="number" max="99" step="1"  class="form-control input-sm" id="historico" name="historico" value="<?= $datOs->historico?>" required/>
								</div>
							</fieldset>
							<fieldset class="col-md-2">
								<div class="form-group"> 
						...
						<div class="row">
							<fieldset class="col-md-3">
								<div class="form-group"> 
									...
									<input type="text" class="form-control input-sm" id="cliente" name="cliente" value="<?= $datOs->cliente?>"/> 
						...
						<div class="row">
							<fieldset class="col-md-3">							
								<div class="form-group"> 
									...
									<input type="text" class="form-control input-sm" id="equipamento" name="equipamento" value="<?= $datOs->equipamento?>"/> 
								</div>
							</fieldset>
							<fieldset class="col-md-2">		
								<div class="form-group"> 
									<label for="marca">Marca</label>
									<input type="text" class="form-control input-sm " id="marca" name="marca" value="<?= $datOs->marca?>" />
								</div>						
							</fieldset>	
							...
							<fieldset class="col-md-2">	
								<div class="form-group"> 
									...
									<input type="text" class="form-control input-sm" id="modelo" name="modelo" value="<?= $datOs->modelo?>"/>  
								</div>
							</fieldset>
							<fieldset class="col-md-2">
								<div class="form-group">
									<label for="potencia">Potencia</label>
									<input type="text" class="form-control input-sm" id="potencia" name="potencia" value="<?= $datOs->potencia?>"/> 
								</div>
							</fieldset>
							<fieldset class="col-md-2">
								<div class="form-group">
									<label for="tensao-nominal">Tensão Nominal</label>
									<input type="text" class="form-control input-sm" id="tensao-nominal" name="tensao_nominal" value="<?= $datOs->tensao_nominal?>"/> 
								</div>
							</fieldset>
						</div>	
						<div class="row">
							<fieldset class="col-md-3">
								<div class="form-group">
									...
									<input type="text" class="form-control input-sm" id="setor_maquina" name="setor_maquina" value="<?= $datOs->setor_maquina?>"/> 
								</div>
							</fieldset>						
							<fieldset class="col-md-3">	
								<div class="form-group"> 
									<label for="num-serie">Número de Série</label>
									<input type="text" class="form-control input-sm" id="num-serie" name="num_serie" value="<?= $datOs->num_serie?>"/> 
								</div>
							</fieldset>							
							<fieldset class="col-md-2">		
								<div class="form-group"> 
									<label for="rotacao">RPM</label>
									<input type="text" class="form-control input-sm " id="rotacao" name="rotacao" value="<?= $datOs->rotacao?>"/> 
								</div>
							</fieldset>	
							<fieldset class="col-md-1">
								<div class="form-group"> 
									<label for="num-polos">Polos</label>
									<input type="text" class="form-control input-sm " id="num-polos" name="num_polos" value="<?= $datOs->num_polos?>"/> 
								</div>	
							</fieldset>
							<fieldset class="col-md-2">	
								<div class="form-group"> 
									<label for="corrente-nominal">Corrente Nominal</label>
									<input type="text" class="form-control input-sm" id="corrente-nominal" name="corrente_nominal" value="<?= $datOs->corrente_nominal?>"/> 
								</div>						
							</fieldset>					
						</div>
						<!-- -->
						<div class="row">
							<fieldset class="col-md-3">		
								<div class="form-group"> 
									...
									<input type="text" class="form-control input-sm" id="num_maquina" name="num_maquina" value="<?= $datOs->num_maquina?>"/> 
								</div>						
							</fieldset>
							<fieldset class="col-md-1">		
								<div class="form-group"> 
									<label for="centro_custo">C.C.</label>
									<input type="text" class="form-control input-sm" id="centro_custo" name="centro_custo"value="<?= $datOs->centro_custo?>"/> 
								</div>						
							</fieldset>
							<fieldset class="col-md-7">
								<div class="form-group"> 
									<label for="complemento">Complemento</label>
									<textarea rows="1" class="form-control input-sm" id="complemento" name="complemento"><?= $datOs->complemento?></textarea>
								</div>
							</fieldset>
						</div>
						<!-- -->
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="row">
							...
							<fieldset class="col-md-3">
								<div class="form-group"> 
									<label for="fechamento">Fech em</label>
