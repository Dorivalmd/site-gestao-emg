	...
	<div  class="container">
		...
		<form action="<?=base_url($metRout)?>" method="post" class="form-incluir">  			
						...
						<div class="row">
							...
							<fieldset class="col-md-2">							
								<div class="form-group"> 
									...
									<input type="text" class="form-control input-sm" id="desc_percento" name="desc_percento" value="<?= $desc_percento?>" disabled> 
								</div>
							</fieldset>							
							<fieldset class="col-md-2">
								<div class="form-group"> 
									<label for="desc_valor">Vlr Desc</label>
									<input type="text" class="form-control input-sm" id="desc_valor" name="desc_valor" value="<?= $desc_valor?>" disabled/>
								</div>
							</fieldset>		
							<fieldset class="col-md-2">		
								<div class="form-group"> 
			...
			<input type="hidden" name="desc_percento" value="<?= $desc_percento?>"/> 
			<input type="hidden" name="desc_valor" value="<?= $desc_valor?>"/> 
