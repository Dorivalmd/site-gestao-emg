				...
				<div class="panel panel-primary ">
					...
					<div class="panel-body">
						<div class="row">
								...
								<fieldset class="col-md-6">							
									<div class="form-group form-group-lg"> 
										<label class="col-sm-6 control-label" for="original">DADOS ORIGINAIS</label>
										<div class="col-sm-6">
											<label class="radio-inline">
											  <input type="radio" id="original" name="original" <?php if($rebob->original == 'sim'){echo "checked='checked'";}?> >SIM
											</label>
											<label class="radio-inline">
